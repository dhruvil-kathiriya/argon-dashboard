        ...
        <>
            ...
            <aside className="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret" id="sidenav-main">
                ...
                <div className="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item mt-3">
                            <h6 className="ps-4 me-4 pe-2 text-uppercase text-xs font-weight-bolder opacity-6">صفحات المرافق</h6>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link " href="#">
                                <div className="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <div className="sidenav-footer mx-3 ">
                    ...
                    <a href="#" target="_blank" className="btn btn-dark btn-sm w-100 mb-3">توثيق</a>
                    <a className="btn btn-primary btn-sm mb-0 w-100" href="#" type="button">التطور للاحترافية</a>
                </div>
            </aside>
            <main className="main-content position-relative border-radius-lg overflow-hidden">
                                    ...
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <p className="text-sm mb-0 text-capitalize font-weight-bold">أموال اليوم</p>
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <p className="text-sm mb-0 text-capitalize font-weight-bold">مستخدمو اليوم</p>
                                                <h5 className="font-weight-bolder mb-0">
                                                    2,300
                                                    <span className="text-success text-sm font-weight-bolder">+33%</span>
                                                </h5>
                                            </div>
                                        </div>
                                        <div className="col-4 text-start">
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <p className="text-sm mb-0 text-capitalize font-weight-bold">عملاء جدد</p>
                                                <h5 className="font-weight-bolder mb-0">
                                                    +3,462
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="numbers">
                                                <p className="text-sm mb-0 text-capitalize font-weight-bold">مبيعات</p>
                                                <h5 className="font-weight-bolder mb-0">
                                                    $103,430
                                        ...
                                        <div className="col-lg-6 mb-lg-0 mb-4">
                                            <div className="d-flex flex-column h-100">
                                                ...
                                                <a className="text-dark font-weight-bold ps-1 mb-0 icon-move-left mt-auto" href="#">
                                                    اقرأ المستندات
                                                    <i className="fas fa-arrow-left text-sm ms-1" aria-hidden="true"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 me-auto ms-0 text-center">
                                            <div className="bg-gradient-primary border-radius-lg min-height-200">
                                                ...
                                                <div className="position-relative pt-5 pb-4">
                                                    <img className="max-width-500 w-100 position-relative z-index-2" src="@/assets/img/illustrations/rocket-white.png" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
              ...
              <div className="card-body position-relative z-index-1 p-3 h-100">
                <div className="d-flex flex-column h-100">
                  ...
                  <a className="text-white font-weight-bold ps-1 mb-0 icon-move-left mt-auto" href="#">اقرأ المستندات
                    <i className="fas fa-arrow-left text-sm ms-1" aria-hidden="true"></i>
                  </a>
                </div>
              </div>
                    ...
                    <div className="row mt-4">
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                        <div className="chart">
                                            <canvas id="chart-bars" className="chart-canvas" height="170px"></canvas>
                                        </div>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-3 py-3 ps-0">
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <p className="text-xs mt-1 mb-0 font-weight-bold">المستخدمون</p>
                                                </div>
                                            ...
                                            <div className="col-3 py-3 ps-0">
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <p className="text-xs mt-1 mb-0 font-weight-bold">نقرات</p>
                                                </div>
                                            ...
                                            <div className="col-3 py-3 ps-0">
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <p className="text-xs mt-1 mb-0 font-weight-bold">مبيعات</p>
                                                </div>
                                            ...
                                            <div className="col-3 py-3 ps-0">
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <p className="text-xs mt-1 mb-0 font-weight-bold">العناصر</p>
                                                </div>
                        ...
                        <div className="col-lg-7">
                            <div className="card">
                                ...
                                <div className="card-body p-3">
                                    <div className="chart">
                                        <canvas id="chart-line" className="chart-canvas" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="card shadow-lg">
                    ...
                    <div className="card-body pt-sm-3 pt-0 overflow-auto">
                        ...
                        <div className="d-flex">
                            <button className="btn bg-gradient-primary w-100 px-3 mb-2 active ms-2" data-class="bg-white" onclick="sidebarType(this)">White</button>
                        ...
                        <div className="d-flex my-3">
                            ...
                            <div className="form-check form-switch ps-0 ms-auto my-auto">
                                <input className="form-check-input mt-1 float-end me-auto" type="checkbox" id="navbarFixed" onclick="navbarFixed(this)" />
                            </div>
                        </div>
                        ...
                        <div className="mt-2 mb-5 d-flex">
                            ...
                            <div className="form-check form-switch ps-0 ms-auto my-auto">
                                <input className="form-check-input mt-1 float-end me-auto" type="checkbox" id="dark-version" onclick="darkMode(this)" />
                            </div>
                        </div>
